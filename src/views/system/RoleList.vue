    ...
    <el-card>
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <el-button type="primary" :icon="Plus" v-permission="'admin:role:create'" @click="handleAdd">新增角色</el-button>
          <el-button type="success" :icon="Upload" v-permission="'admin:role:import'" @click="importDialogRef?.open()">导入</el-button>
          <el-button type="warning" :icon="Download" v-permission="'admin:role:export'" @click="handleExportAll">全部导出</el-button>
          <el-button type="warning" :icon="Download" :disabled="selectedIds.length === 0" v-permission="'admin:role:export'" @click="handleExportSelected">导出选中</el-button>
        </div>
      ...
      >
        ...
        <el-table-column label="操作" min-width="200" fixed="right">
          <template #default="{ row }">
            <el-button size="small" type="primary" v-permission="'admin:role:edit'" @click="openPermDialog(row)">分配权限</el-button>
            <el-button size="small" type="primary" v-permission="'admin:role:edit'" @click="handleEdit(row)">编辑</el-button>
            <el-button size="small" type="danger" v-permission="'admin:role:delete'" @click="handleDelete(row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
